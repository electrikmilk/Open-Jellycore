...
public enum ShortcutGlyph: String, CaseIterable, Identifiable {
    ...
    case appleCash
    case appleMathNotes
    case appleMindfulness
    case appleBreathe
    case appleReflect
    case appleMeditate
    case appleStateOfMind
    case appleCycleTracking
    case appleNews
    case appleHealthTrends
    case applePages
    case appleKeynote
    case appleNumbers
    case bezierCurve
    case roadCurvedLeft
    case roadCurvedRight
    case pointsConnection
    case pointsCurvedSPath
    case sparkle
    case arrowUpRight
    case arrowUpLeft
    case textInsert
    ...
    case airplaneTicket
    case airplaneSeat
    case personWalkingSuitcase
    case appleClassicalPages
    case textSquareFilled
    case characterTextJustify
    case graph2D
    case mathOperators
    case circle
